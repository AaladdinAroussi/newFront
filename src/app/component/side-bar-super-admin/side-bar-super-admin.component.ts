...
@Component({
  ...
  templateUrl: './side-bar-super-admin.component.html',
  styleUrls: ['./side-bar-super-admin.component.css']
})
export class SideBarSuperAdminComponent implements OnInit {
constructor(private fb: FormBuilder, private commonService: CommonService, private authService: AuthService, private router: Router) 
   { }
